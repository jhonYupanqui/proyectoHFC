...
peticiones.armandoEsquemaModulosPermisos = function armandoEsquemaModulosPermisos(data,texto,printResult)
{
  ...
  let esquemaModulos = `<div class="accordion" id="accordionModulosUser${texto}">`
...
peticiones.seleccionarPermisosByRoles = function seleccionarPermisosByRoles(idRol,dataIdent,modalShow,loadEsquema,loadEsquemaRpta){
