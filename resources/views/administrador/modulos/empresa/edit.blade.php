                    ...
                    <div class="card-body px-2 py-1"> 
                        ...
                        <section class="form row my-2 mx-0" id="form_update_detail">
                            ...
                            <div class="form-group row mx-0 px-2 col-12 col-sm-12 col-md-6 col-lg-6 ">
                                ...
                                <input type="text" name="nombreUpdate" id="nombreUpdate" value="{{ $rolUpdate->response->data->rol }}" class="col-sm-7 col-md-8 form-control form-control-sm shadow-sm  text-uppercase validateText">
                            ...
                            <div class="form-group row mx-0 px-2 col-12 col-sm-12 col-md-6 col-lg-6 ">
                                ...
                                <select name="especialUpdate" id="especialUpdate" class="col-sm-7  col-md-8 form-control form-control-sm shadow-sm validateSelect">
                            ...
                            <div class="form-group row mx-0 px-2 col-12 col-sm-12 col-md-6 col-lg-6 ">
                                ...
                                <select name="referenciaUpdate" id="referenciaUpdate" class="col-sm-7  col-md-8 form-control form-control-sm shadow-sm validateSelect">
