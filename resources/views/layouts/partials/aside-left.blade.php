    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        @auth
          ...
          <div class="info">
              <a href="{{route('perfil.usuario.detalle',[Auth()->user()->username])}}" class="d-block">{{ Auth()->user()->username}}  </a>
          </div> 
        @endauth
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview @routeIs('administrador') menu-open @endif">
            <a href="javascript:void(0)" class="nav-link @routeIs('administrador') active @endif ">
