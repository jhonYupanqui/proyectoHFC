...
function registroEmpresaStore() {
  ...
  $.ajax({
    ...
    _globalResources_forms_limpia_js__WEBPACK_IMPORTED_MODULE_1__["default"].limpiaFormEmpresa(); //  console.log(data)
    ...
    var empresa = data.response.data;
    $("#body-success-modal").html("\n          <h5 class=\"text-success text-center text-uppercase font-weight-bold\">Empresa creada correctamente</h5>\n          <p class=\"text-center font-weight-bold font-italic\">La empresa: \"".concat(empresa.empresa, "\" se creo corretamente.</p>\n           \n         "));
