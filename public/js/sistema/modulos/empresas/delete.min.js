...
$(function () {
  ...
  $('body').on("click", ".accionEmpresaDelete", function () {
    ...
    if (empresaId) {
      $.ajax({
        url: "/administrador/empresa/".concat(empresaId, "/eliminar"),
        method: "post",
        data: {},
        dataType: "json"
      }).done(function (data) {
        ...
        $("#body-success-modal").html("\n            <h5 class=\"text-success text-center text-uppercase font-weight-bold\">Empresa eliminada</h5>\n            <p class=\"text-center font-weight-bold font-italic\">Se elimin\xF3 la empresa:  \"".concat(empresa.empresa, "\" correctamente</p>\n            \n            "));
