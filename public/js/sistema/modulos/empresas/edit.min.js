...
function actualizarEmpresa() {
  ...
  var idEmpresa = $("#idUpdate").val();
  var empresa = $("#nombreUpdate").val();
  ...
  $.ajax({
    url: "/administrador/empresa/".concat(idEmpresa, "/update"),
    method: "put",
    data: {
      empresa: empresa
    },
    ...
    $("#body-success-modal").html("\n            <h5 class=\"text-success text-center text-uppercase font-weight-bold\">Empresa actualizada</h5>\n            <p class=\"text-center font-weight-bold font-italic\">Se actualiz\xF3 la empresa: ".concat(empresa.empresa, " correctamente</p>\n            \n            "));
