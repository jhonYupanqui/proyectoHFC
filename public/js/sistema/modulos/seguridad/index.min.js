...
/***/ "./resources/js/administrador/modulos/seguridad/index.js":
/*!***************************************************************!*\
  !*** ./resources/js/administrador/modulos/seguridad/index.js ***!
  \***************************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $(".updateSeguridadBtn").click(function () {
    var idSeguridad = $(this).data("id");
    var texto = $(this).data("texto");
    var valor = $("#parametersSeguridadUpdate".concat(idSeguridad));
    var validacionUpdate = validacionCotinueUpdate(valor, texto);
    ...
    if (idSeguridad) {
      $.ajax({
        url: "/administrador/seguridad/".concat(idSeguridad, "/update"),
        method: "post",
        data: {
          "periodo": valor.val()
        },
      ...
      $("#body-reload-modal").html("\n                                            <p>No se puede encontrar al parametro de seguridad, recargue la p\xE1gina e intentelo de nuevo.</p>\n                                        ");
...
function validacionCotinueUpdate(valor, texto) {
  ...
  if (!_globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_0__["default"].isValidText(valor.val())) {
    _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_0__["default"].isValidateInputText(valor);
    $("#errors_update").html("El campo ".concat(texto, " es requerido"));
    return false;
  }

  if (!_globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_0__["default"].isValidNumber(valor.val())) {
    _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_0__["default"].isValidateInputText(valor);
    $("#errors_update").html("El campo ".concat(texto, " debe ser de formato num\xE9rico positivo"));
    return false;
  }

  if (valor.val() < 1) {
    _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_0__["default"].isValidateInputText(valor);
    $("#errors_update").html("El campo ".concat(texto, " no puede ser menor a 1."));
    return false;
  }
...
/***/ 20:
/*!*********************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/seguridad/index.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\seguridad\index.js */"./resources/js/administrador/modulos/seguridad/index.js");
