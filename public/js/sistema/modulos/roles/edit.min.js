...
$(function () {
  ...
  loadEditModulosPermisosUser().then(function () {
    var checkedUsers = PERMISOS_CHECKED.response.data;
    _peticiones_js__WEBPACK_IMPORTED_MODULE_3__["default"].checkedPermisosRol(checkedUsers, "edit");
  });
});

function actualizarRol() {
  var validacionConitnueStore = validacionCotinueUpdate();
  ...
  var rolUpdateId = $("#idUpdate").val();
  var datos = {};
  var rol = $("#nombreUpdate").val();
  datos.rol = rol;

  if ($("#especialUpdate")) {
    var esAdministrador = $("#especialUpdate").val();
    datos.esAdministrador = esAdministrador;
  }

  if ($("#referenciaUpdate")) {
    var rolPadre = $("#referenciaUpdate").val();
    datos.rolPadre = rolPadre;
  }

  var permisos = [];
  var permisosGenerales = $("#updateModulosAndPermisosList input[type=checkbox]");
  ...
  $.ajax({
    url: "/administrador/rol/".concat(rolUpdateId, "/update"),
    method: "put",
    data: datos,
    dataType: "json"
  }).done(function (data) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _peticiones_js__WEBPACK_IMPORTED_MODULE_3__["default"].armandoEsquemaModulosPermisos(dataModulos, "edit", $("#updateModulosAndPermisosList"));
