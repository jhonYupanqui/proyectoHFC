...
/***/ "./resources/js/administrador/modulos/role/delete.js":
/*!***********************************************************!*\
  !*** ./resources/js/administrador/modulos/role/delete.js ***!
  \***********************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $('body').on("click", ".accionRolDelete", function () {
    var rolIdentificador = $(this).data('id');
    ...
    if (rolIdentificador) {
      $.ajax({
        url: "/administrador/rol/".concat(rolIdentificador, "/eliminar"),
        method: "post",
        data: {},
        dataType: "json"
      }).done(function (data) {
        ...
        $("#body-success-modal").html("\n            <h5 class=\"text-success text-center text-uppercase font-weight-bold\">Rol eliminado</h5>\n            <p class=\"text-center font-weight-bold font-italic\">Se elimin\xF3 el rol ".concat(rol.rol, " correctamente</p>\n            \n            "));
        $("#successModal").modal("show");

        _this.closest('tr').remove();
      }).fail(function (jqXHR, textStatus) {
        console.log("error", jqXHR, textStatus); // $("#body-errors-modal").html(jqXHR.responseText)
...
/***/ 13:
/*!*****************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/role/delete.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\role\delete.js */"./resources/js/administrador/modulos/role/delete.js");
